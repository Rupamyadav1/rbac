                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <textarea name="text" placeholder="content" id="text" class="border-gray-300 shadow-sm w-1/2 rounded-lg"></textarea>
                            ...
                            <div class="my-3">
                                <input type="text" name="author" id="author" placeholder="author" class="border-gray-300 
                                shadow-sm w-1/2 rounded-lg" >
                                @error('author')
                                <p class="text-red-400">{{$message}}</p>
